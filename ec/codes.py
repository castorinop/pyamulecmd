...
op['get_update'] = 0x52
op['clear_completed'] = 0x53
op['client_swap_to_another_file'] = 0x54
op['shared_file_set_comment'] = 0x55
op['server_set_static_prio'] = 0x56
op['friend'] = 0x57
tag['string'] = 0x0000
...
tag['passwd_salt'] = 0x000B
tag['can_zlib'] = 0x000C
tag['can_utf8_numbers'] = 0x000D
tag['can_notify'] = 0x000E
tag['ecid'] = 0x000F
...
tag['stats_logger_message'] = 0x020D
tag['stats_kad_firewalled_udp'] = 0x020E
tag['stats_kad_indexed_sources'] = 0x020F
tag['stats_kad_indexed_keywords'] = 0x0210
tag['stats_kad_indexed_notes'] = 0x0211
tag['stats_kad_indexed_load'] = 0x0212
tag['stats_kad_ip_adress'] = 0x0213
tag['stats_buddy_status'] = 0x0214
tag['stats_buddy_ip'] = 0x0215
tag['stats_buddy_port'] = 0x0216
tag['stats_kad_in_lan_mode'] = 0x0217
tag['stats_total_sent_bytes'] = 0x0218
tag['stats_total_received_bytes'] = 0x0219
tag['stats_shared_file_count'] = 0x021A
tag['partfile'] = 0x0300
...
tag['partfile_stopped'] = 0x0317
tag['partfile_download_active'] = 0x0318
tag['partfile_lost_corruption'] = 0x0319
tag['partfile_gained_compression'] = 0x031A
tag['partfile_saved_ich'] = 0x031B
tag['partfile_source_names_counts'] = 0x031C
tag['partfile_available_parts'] = 0x031D
tag['partfile_hash'] = 0x031E
tag['partfile_shared'] = 0x031F
tag['partfile_hashed_part_count'] = 0x0320
tag['partfile_a4afauto'] = 0x0321
tag['partfile_a4af_sources'] = 0x0322
...
tag['knownfile_filename'] = 0x0408
tag['knownfile_complete_sources_low'] = 0x0409
tag['knownfile_complete_sources_high'] = 0x040A
tag['knownfile_prio'] = 0x040B
tag['knownfile_on_queue'] = 0x040C
tag['knownfile_complete_sources'] = 0x040D
tag['knownfile_comment'] = 0x040E
tag['knownfile_rating'] = 0x040F
tag['server'] = 0x0500
...
tag['server_ip'] = 0x050C
tag['server_port'] = 0x050D
tag['client'] = 0x0600
tag['client_software'] = 0x0601
tag['client_score'] = 0x0602
tag['client_hash'] = 0x0603
tag['client_friend_slot'] = 0x0604
...
tag['client_download_state'] = 0x060C
...
tag['client_ident_state'] = 0x0617
tag['client_obfuscation_status'] = 0x0618
tag['client_currentlyunused1'] = 0x0619
tag['client_remote_queue_rank'] = 0x061A
tag['client_disable_view_shared'] = 0x061B
tag['client_upload_state'] = 0x061C
tag['client_ext_protocol'] = 0x061D
tag['client_user_id'] = 0x061E
tag['client_upload_file'] = 0x061F
tag['client_request_file'] = 0x0620
tag['client_a4af_files'] = 0x0621
tag['client_old_remote_queue_rank'] = 0x0622
tag['client_kad_port'] = 0x0623
tag['client_part_status'] = 0x0624
tag['client_next_requested_part'] = 0x0625
tag['client_last_downloading_part'] = 0x0626
tag['client_remote_filename'] = 0x0627
tag['client_mod_version'] = 0x0628
tag['client_os_info'] = 0x0629
tag['client_available_parts'] = 0x062A
tag['client_upload_part_status'] = 0x062B
...
tag['search_parent'] = 0x0709
tag['friend'] = 0x0800
tag['friend_name'] = 0x0801
tag['friend_hash'] = 0x0802
tag['friend_ip'] = 0x0803
tag['friend_port'] = 0x0804
tag['friend_client'] = 0x0805
tag['friend_add'] = 0x0806
tag['friend_remove'] = 0x0807
tag['friend_friendslot'] = 0x0808
tag['friend_shared'] = 0x0809
...
tag['general_check_new_version'] = 0x1204
...
tag['directories_incoming'] = 0x1A01
tag['directories_temp'] = 0x1A02
tag['directories_shared'] = 0x1A03
tag['directories_share_hidden'] = 0x1A04
