...
opcode['get_connstate'] = 0x0B
opcode['stats'] = 0x0C
opcode['get_dload_queue'] = 0x0D
opcode['get_uload_queue'] = 0x0E
opcode['get_wait_queue'] = 0x0F
opcode['get_shared_files'] = 0x10
opcode['shared_set_prio'] = 0x11
opcode['partfile_remove_no_needed'] = 0x12
opcode['partfile_remove_full_queue'] = 0x13
opcode['partfile_remove_high_queue'] = 0x14
opcode['partfile_cleanup_sources'] = 0x15
opcode['partfile_swap_a4af_this'] = 0x16
opcode['partfile_swap_a4af_this_auto'] = 0x17
opcode['partfile_swap_a4af_others'] = 0x18
opcode['partfile_pause'] = 0x19
opcode['partfile_resume'] = 0x1A
opcode['partfile_stop'] = 0x1B
opcode['partfile_prio_set'] = 0x1C
opcode['partfile_delete'] = 0x1D
opcode['partfile_set_cat'] = 0x1E
opcode['dload_queue'] = 0x1F
opcode['uload_queue'] = 0x20
opcode['wait_queue'] = 0x21
opcode['shared_files'] = 0x22
opcode['sharedfiles_reload'] = 0x23
opcode['sharedfiles_add_directory'] = 0x24
opcode['rename_file'] = 0x25
opcode['search_start'] = 0x26
opcode['search_stop'] = 0x27
opcode['search_results'] = 0x28
opcode['search_progress'] = 0x29
opcode['download_search_result'] = 0x2A
opcode['ipfilter_reload'] = 0x2B
opcode['get_server_list'] = 0x2C
opcode['server_list'] = 0x2D
opcode['server_disconnect'] = 0x2E
opcode['server_connect'] = 0x2F
opcode['server_remove'] = 0x30
opcode['server_add'] = 0x31
opcode['server_update_from_url'] = 0x32
opcode['addlogline'] = 0x33
opcode['adddebuglogline'] = 0x34
opcode['get_log'] = 0x35
opcode['get_debuglog'] = 0x36
opcode['get_serverinfo'] = 0x37
opcode['log'] = 0x38
opcode['debuglog'] = 0x39
opcode['serverinfo'] = 0x3A
opcode['reset_log'] = 0x3B
opcode['reset_debuglog'] = 0x3C
opcode['clear_serverinfo'] = 0x3D
opcode['get_last_log_entry'] = 0x3E
opcode['get_preferences'] = 0x3F
opcode['set_preferences'] = 0x40
opcode['create_category'] = 0x41
opcode['update_category'] = 0x42
opcode['delete_category'] = 0x43
opcode['get_statsgraphs'] = 0x44
opcode['statsgraphs'] = 0x45
opcode['get_statstree'] = 0x46
opcode['statstree'] = 0x47
opcode['kad_start'] = 0x48
opcode['kad_stop'] = 0x49
opcode['connect'] = 0x4A
opcode['disconnect'] = 0x4B
opcode['get_dload_queue_detail'] = 0x4C
opcode['kad_update_from_url'] = 0x4D
opcode['kad_bootstrap_from_ip'] = 0x4E
tag['string'] = 0x0000
